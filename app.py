...
# Function to perform fuzzy lookup and match fields
def fuzzy_lookup(field, available_fields, threshold=80):
...
def plot_sankey(ticker, report_type, year, quarter, unit):
    try:
        ...
        cost_of_revenue = get_value_safely(financials, 'Cost Of Goods Sold')
        ...
        sga = get_value_safely(financials, 'Selling General and Administrative')
